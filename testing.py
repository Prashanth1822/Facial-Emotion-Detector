    ...
    def load_model(self):
        ...
        try:
            ...
            model_files = [
                ...
                "emotion_detector_20251124_223113.json",
                "emotion_model.json"
            ]
            weight_files = [
                "emotiondetector.h5", 
                "emotion_detector_20251124_223113.h5",
                "emotion_model.h5"
            ]
            ...
            if not model_path or not weights_path:
                ...
                print("   JSON files:", model_files)
                print("   H5 files:", weight_files)
                return False
    ...
    def process_frame(self, frame):
        ...
        try:
            ...
            if frame_emotions:
                ...
                self.current_data['dominant_emotion'] = 'No Face'
    ...
    if command == 'start_detection':
        if not is_detection_active:
            if detector.start_detection():
                ...
                print("✅ Detection started and thread launched")
            else:
                socketio.emit('control_response', {
                    'status': 'error',
        ...
        detector.current_data['total_detections'] = 0
        socketio.emit('control_response', {
            'status': 'success',
...
if __name__ == "__main__":
    ...
    if found_model and found_weights:
        print(f"✅ Found model: {found_model}")
        print(f"✅ Found weights: {found_weights}")
    else:
        print("❌ Model files not found! Please make sure you have:")
        print("   - emotiondetector.json OR emotion_detector_20251124_223113.json")
        print("   - emotiondetector.h5 OR emotion_detector_20251124_223113.h5")
